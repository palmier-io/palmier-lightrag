...
Your task:
- Read the file content and the repository structure. The file content can be in the following two formats:
  - Skeleton: A skeleton of the file content generated by ast-grep. It contains the function/class/method/type definitions and imports/comments, but not the actual code.
  - Content: The actual file content (first N characters).
